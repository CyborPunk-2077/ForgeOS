...
let OrganizationsController = class OrganizationsController {
    ...
    async addMember(organizationId, membershipData) {
        return this.organizationsService.addMember(parseInt(organizationId), membershipData.userId, membershipData.role);
    }
    async removeMember(organizationId, userId) {
        return this.organizationsService.removeMember(parseInt(organizationId), parseInt(userId));
    }
